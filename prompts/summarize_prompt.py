...
Alongside each characteristic should be its number of occurrences. For instance, "1. ventrals, 15"

Step 2. Summarization: Generate a summary report that includes: your key findings, including most common trends and 
patterns. """